...
//need to use this custom Hook to load Images into canvas
    const DeskImage = (props) => {
        ...
        return <Image image={image}  width={15} height={12} x={70} y={20} rotation={props.angle} />;
    };
...
*/
    ...
    return(
        <>
            ...
            <Stage width={props.w} height={props.h} offsetX={-50} offsetY={-50}
