...
const data=[
    {location: <><img src={Flats} width="20"/> Floors No 5 / Rooms: 5</>,maxcapacity:<><img src={UsersIcon} width="20"/> 46</>,purpose:<select className="form-control"><option>Study</option><option>Meeting</option><option>Interview</option><option>Others</option></select>,notes:<textarea className="form-control" rows="1" ></textarea>,action:<NavLink to="/pages/confirm-seats" className="btn btn-primary">Reserve Seats</NavLink>},
    {location: <><img src={Flats} width="20"/> Floors No 5 / Rooms: 5</>,maxcapacity:<><img src={UsersIcon} width="20"/> 46</>,purpose:<select className="form-control"><option>Study</option><option>Meeting</option><option>Interview</option><option>Others</option></select>,notes:<textarea className="form-control" rows="1" ></textarea>,action:<NavLink to="/pages/confirm-seats" className="btn btn-primary">Reserve Seats</NavLink>},
    {location: <><img src={Flats} width="20"/> Floors No 5 / Rooms: 5</>,maxcapacity:<><img src={UsersIcon} width="20"/> 46</>,purpose:<select className="form-control"><option>Study</option><option>Meeting</option><option>Interview</option><option>Others</option></select>,notes:<textarea className="form-control" rows="1"></textarea>,action:<NavLink to="/pages/confirm-seats" className="btn btn-primary">Reserve Seats</NavLink>},
]
const columns=[
    {title:'Location',field:'location'},{title:'Max Capacity',field:'maxcapacity'},{title:'Purpose',field:'purpose'},{title:'Notes',field:'notes'},{title:'Action',field:'action'},
]
const tableIcons = {
                                ...
                                <div className="kt-login__body" >
                                    <Container>
                                        <div className="text-center mb-5">
                                            <h2>Available Seats in Areas</h2>
                                        </div>
                                    <MaterialTable title=""
                                            data={data}
                                            columns={columns}
